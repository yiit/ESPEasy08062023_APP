...
void setup() {
  ...
  if (tpScan()) // Scan for any supported printer name
  {
    ...
    if (tpConnect())
    {
      ...
      tpPrintCustomText((GFXfont *)&FreeSerif12pt7b, 0, (char *)"ENDUTEK TEKNOLOJi SiSTEMLERi www.endutek.com.tr");
      Serial.println();
      tpPrintCustomText((GFXfont *)&Open_Sans_Bold_64, 0, (char *)"ENDUTEK TEKNOLOJi SiSTEMLERi www.endutek.com.tr");
      //tpPrintCustomText((GFXfont *)&FreeMono9pt7b, 0, (char *)"www.endutek.com.tr");
      //tpPrintCustomText((GFXfont *)&FreeMonoBold24pt7b, 0, (char *)"www.endutek.com.tr");
