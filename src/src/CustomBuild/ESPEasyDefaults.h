...
#define DEFAULT_SERIAL_BAUD                     9600  // Serial Port Baud Rate
#endif
...
# define GITHUB_RELEASES_LINK_PREFIX "<a href='https://github.com/endutek/ENFi/releases' title='Click to show latest release on Github' target='_blank' style='font-size: 15px; text-decoration: none'>"
#endif
