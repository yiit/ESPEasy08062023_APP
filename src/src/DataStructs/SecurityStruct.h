...
struct SecurityStruct
{
  ...
  uint8_t       md5[16] = {0};
  bool          LisansControl;
  bool          LisansControlSERiALSERVER;
  bool          LisansControlSERiALCLiENT;
  bool          LisansControlSERiALTCPMODBUSSLAVE;
  bool          LisansControlHRC;
  bool          LisansControlFYZ;
  bool          LisansControlFYZPLU;
  bool          LisansControlEYZ;
  bool          LisansControlEYZPLU;
  bool          LisansControlIND;
  bool          LisansControlBLECLiENT;
  bool          LisansControlBLESERVER;
  bool          LisansControlTCPMODBUSHRCMESAJ;
};
