...
public:
  ...
  uint8_t       Cli_PrinterIP[4] = {0};
  unsigned int  Cli_PrinterPort = 0;
  boolean       Cli_PrinterAktif = 0;
  float         ind_sifir_kal_degeri = 0;
  float         ind_yuk_kal_degeri = 0;
  int8_t        bluetooth_mod = 0;
  char          bluetooth_mac_address[18] = {0};
  boolean       Web_ServisAktif = 0;
  char          Web_ServisAdres[128] = {0};
  unsigned int  Web_ServisPort = 0;
  int8_t        Web_ServisMod = 0;
  boolean       Button_Aktif = 0;
  boolean       UseSerialBT = 0;
  boolean       UseYonetici = 0;
  int8_t        BaudBit = 0;
  boolean       UseNegatifYaz = 0;
  char          tek_prn[30] = {0};
  char          art_prn[30] = {0};
  char          top_prn[30] = {0};
  char          ek_prn[30] = {0};
  char          seridata_prn[30] = {0};
  boolean       UseCasVersion = 0;
  char          sd_prn[30] = {0};
  boolean       UseSerial1 = false;
  unsigned long BaudRate1 = 9600;
  int8_t        BaudBit1 = 0;
  boolean       Tersle1 = 0;
  char          srv_prn[30] = {0};
  char          http_prn[30] = {0};
  char          plu_tek_prn[30] = {0};
  char          plu_art_prn[30] = {0};
  char          plu_ek_prn[30] = {0};
  char          plu_top_prn[30] = {0};
  uint8_t       SerialBTLogLevel = 0;
  float         hedef_f[5] = {0};
  char          mesaj[8][30] = {0};
  boolean       UseESPNOW = 0;
  int8_t        espnow_mod = 0;
  uint8_t       espnow_mac_address[18] = {0};
  boolean       serial_komut = 0;
