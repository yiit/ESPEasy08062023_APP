...
const __FlashStringHelper* getPluginFunctionName(int function) {
  switch (function) {
    ...
    case PLUGIN_SERIALBT_IN:           return F("SERIALBT_IN");
    case PLUGIN_ONE_HUNDRED_PER_SECOND: return F("PLUGIN_TEN_PER_SECOND");
  }
  return F("Unknown");
}
...
bool mustLogFunction(int function) {
  ...
  switch (function) {
    ...
    case PLUGIN_SERIALBT_IN:           return true;
    case PLUGIN_ONE_HUNDRED_PER_SECOND: return true;
  }
  return false;
}
...
const __FlashStringHelper* getMiscStatsName_F(TimingStatsElements stat) {
  switch (stat) {
    ...
    case TimingStatsElements::PLUGIN_CALL_100PS:          return F("Plugin call 100 p/s");
