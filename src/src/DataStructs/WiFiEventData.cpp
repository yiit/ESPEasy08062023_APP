...
#define WIFI_RECONNECT_WAIT                  30000  // 30000 in milliSeconds degisti

#define CONNECT_TIMEOUT_MAX                  2000   // in milliSeconds

bool WiFiEventData_t::WiFiConnectAllowed() const {
  if (WiFi.status() == WL_IDLE_STATUS) {
    // FIXME TD-er: What to do now? Set a timer?
    // return false; //degisti
...
void WiFiEventData_t::markWiFiTurnOn() {
  setWiFiDisconnected();
  //lastDisconnectMoment.clear();  //degisti
