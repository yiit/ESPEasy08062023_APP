...
bool WiFiConnected() {
  ...
  //if (validWiFi && WiFi.channel() != WiFiEventData.usedChannel) {  // degisti
    //validWiFi = false; // degisti
  //} // degisti
  ...
  if (timeoutReached && !WiFiEventData.wifiSetup) {
    ...
    //if (!wifiAPmodeActivelyUsed()) { //degisti
...
void resetWiFi() {
  //if (wifiAPmodeActivelyUsed()) return;  //degisti
...
bool WiFiScanAllowed() {
  ...
  //if (!wifiAPmodeActivelyUsed() && !NetworkConnected()) { //degisti
  //  return true; //degisti
  //} //degisti
