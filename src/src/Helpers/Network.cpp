...
/********************************************************************************************\
   Status LED
 \*********************************************************************************************/
void statusLED(bool traffic, bool data)
{
  ...
  if (gnStatusValueCurrent != nStatusValue)
  {
    ...
    if (data)
      set_Gpio_PWM(Settings.Pin_status_led, pwm, 100); // degisti 1000
    else
      set_Gpio_PWM(Settings.Pin_status_led, pwm, 1000); // degisti 1000
  }
}