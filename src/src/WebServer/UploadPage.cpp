...
#if defined(ESP32)
        filename.replace("#fyz#",    "rules/fyz");
        filename.replace("#fyzplu#", "rules/fyzplu");
        filename.replace("#eyz#",    "rules/eyz");
        filename.replace("#eyzplu#", "rules/eyzplu");
        filename.replace("#plu#",    "rules/plu");
        filename.replace("#logo#",   "rules/logo");
        filename.replace("#ind#",    "rules/ind");
        filename.replace("#hrc#",    "rules/hrc");
        filename.replace("#srv#",    "rules/srv");
        filename.replace("#cnt#",    "rules/cnt");
        filename.replace("#cli#",    "rules/cli");
#else
        filename.replace("fyz#",    "rules/fyz/");
        filename.replace("fyzplu#", "rules/fyzplu/");
        filename.replace("eyz#",    "rules/eyz/");
