...
def main():
    ...
    def add_spi_flash_subparsers(parent, auto_detect=False):
        ...
        parent.add_argument('--flash-freq', '-ff', help='SPI Flash frequency',
                            choices=['40m', '26m', '20m', '80m'],
                            default=os.environ.get('ESPTOOL_FF', '40m'))
        parent.add_argument('--flash-mode', '-fm', help='SPI Flash mode',
        ...
        parent.add_argument('--flash-size', '-fs', help='SPI Flash size in Mbit', type=lambda s: s.lower(),
                            choices=choices,
